...
def render_login_page(error: str | None = None) -> str:
    ...
    <section class="login-card">
      <div class="hero-copy">
        ...
        <h2>Track assets, follow-ups and release work in one place.</h2>
        <p>
      ...
      <form class="login-form" method="post" action="/login">
        ...
        {error_html}
        <button type="submit">Open Asset Ops</button>
      </form>
    </section>
    """
    return render_layout(title="Asset Ops Login", body=body, page_id="login")
